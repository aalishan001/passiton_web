      ...
      <div className={styles.card}>
        ...
        <section>
          <p>
            ...
            "Platform"), owned and operated by Third Eye Creative, a firm
            registered in India ("Passiton", "we", "our", or "us").
          </p>
          <p>
            By accessing or using Passiton, you agree to be bound by these
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Does not guarantee the quality, safety, legality, or condition of
              any item
            </li>
            <li>
              Is not a party to any interaction or agreement between users
            </li>
          </ul>
          <p>
            All exchanges are strictly user-to-user and undertaken at the users’
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              of entering into a binding agreement under Indian law
            </li>
          </ul>
        </section>
        <hr />
        ...
        <section>
          ...
          <p>
            Passiton reserves the right to remove listings and suspend users
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Passiton does not supervise, facilitate, or participate in
              physical exchanges
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            AI-generated outputs are suggestive only. Users remain fully
        ...
        <section>
          ...
          <p>
            Passiton reserves the right to remove content or suspend users
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Passiton does not guarantee availability, accuracy, or reliability
              of the Platform
            </li>
