...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <p>
        By accessing or using Passiton, you consent to the practices described
        in this Privacy Policy.
      </p>
      <h2>1. Scope & Applicability</h2>
      <p>
        This Privacy Policy applies to all users of the Passiton mobile
        application and website. It governs the processing of digital personal
        data collected directly from users. Passiton acts as a Data Fiduciary
        under the DPDP Act.
      </p>
      ...
      <ul>
        ...
        <li>
          Approximate location (city-level, not precise GPS unless explicitly
          enabled)
        </li>
      </ul>
      <h3>2.3 Sensitive Personal Data</h3>
      <p>
        Passiton does not intentionally collect sensitive personal data such as:
      </p>
      <ul>
      ...
      <p>
        ...
        legal or significant effects on users.
      </p>
      <h2>4. AI & Automated Processing</h2>
      <p>Passiton uses AI-based systems for:</p>
      <ul>
      ...
      <p>
        ...
        accuracy rests with users. No AI profiling is used for advertising or
        pricing.
      </p>
      <h2>5. Data Sharing & Disclosure</h2>
      <p>We do not sell personal data. We may share limited data only with:</p>
      <ul>
      ...
      <p>
        ...
        jurisdictions with adequate data protection. Data is retained only for
        as long as necessary to fulfill stated purposes or comply with law.
        Inactive accounts may be anonymized or deleted.
      </p>
      ...
      <p>
        However, no system is completely secure, and users acknowledge inherent
        risks of digital platforms.
      </p>
      <h2>9. Children’s Privacy</h2>
      <p>
        Passiton is not intended for individuals under 18 years of age. We do
        not knowingly collect personal data from minors.
      </p>
      <h2>10. Cookies & Tracking Technologies</h2>
      <p>Passiton may use cookies or similar technologies to:</p>
      <ul>
      ...
      <p>
        ...
        through the Platform. Continued use constitutes acceptance of the
        revised policy.
      </p>
      <h2>12. Grievance Officer (DPDP Compliance)</h2>
      <p>In accordance with Indian law, the Grievance Officer details are:</p>
      ...
      <p>
        ...
        this Privacy Policy and consent to the processing of your personal data
        as described above.
      </p>
    </div>
  );
